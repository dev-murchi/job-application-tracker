...
export class JobStatusBadge {
  ...
  private readonly statusStyles: Partial<Record<JobStatus, { background: string; text: string }>> =
    {
      [JobStatus.Pending]: {
        background: 'bg-[var(--color-job-status-pending-bg)]',
        text: 'text-[var(--color-job-status-pending-text)]',
      },
      [JobStatus.Interview]: {
      ...
      [JobStatus.Offered]: {
        background: 'bg-[var(--color-job-status-offered-bg)]',
        text: 'text-[var(--color-job-status-offered-text)]',
      },
      [JobStatus.Accepted]: {
        background: 'bg-[var(--color-job-status-accepted-bg)]',
        text: 'text-[var(--color-job-status-accepted-text)]',
      },
      [JobStatus.Declined]: {
        background: 'bg-[var(--color-job-status-declined-bg)]',
        text: 'text-[var(--color-job-status-declined-text)]',
      },
    };
  ...
  readonly colorCssClass = computed(() => {
